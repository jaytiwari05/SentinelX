from PySide6.QtWidgets import (
    ...
    QLabel, QComboBox, QCheckBox, QFrame, QMessageBox, QLineEdit
)
...
class SettingsTab(QWidget):
    ...
    def _build_protection_section(self):
        ...
        self.chk_realtime = QCheckBox("Enable Watchdog Monitor (Monitor J:\\SentinelX_Test for new files)")
    ...
    def save_settings(self):
        ...
        QMessageBox.information(self, "Settings Saved", "Preferences and API keys have been saved successfully.")
